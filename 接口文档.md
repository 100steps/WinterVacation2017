...
|reply|json数组|数组元素为json对象{"number":,"user":"","date":"","text":""},分别为：第几个回复、回复者、回复时间、回复内容，共replynumber个，最多replyamount个|  
...
|--------|----|--------|  
|section|string||  
|type|string|essential/active|  
|kind|string|只有选择精品帖子需要传这个参数，选择精品贴的种类|  
