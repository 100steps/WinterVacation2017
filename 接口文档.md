...
|reply|json数组|数组元素为json对象{"id":"","number":,"user":"","date":"","text":""},分别为：帖子id、第几个回复、回复者、回复时间、回复内容，共replyMumber个，最多replyAmount个|  
